...
#ifndef SEARCHAGRAM_ANALYSIS_LUV_HISTOGRAM_H_
#define SEARCHAGRAM_ANALYSIS_LUV_HISTOGRAM_H_
...
namespace SearchAGram {
  ...
  public:
    ...
    LuvHistogram (const std::string& filename);
    LuvHistogram (cv::Mat mat);
...
#endif /* SEARCHAGRAM_ANALYSIS_LUV_HISTOGRAM_H_ */
