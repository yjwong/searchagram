...
#ifndef SEARCHAGRAM_MATCHER_H_
#define SEARCHAGRAM_MATCHER_H_
...
namespace SearchAGram {
  ...
  public:
    ...
    static void loadIndex_ ();
    static void loadIndexFile_ (boost::filesystem::path path);
