...
#ifndef SEARCHAGRAM_INSTAGRAM_LIKE_H_
#define SEARCHAGRAM_INSTAGRAM_LIKE_H_

#include "instagram_user.h"

namespace SearchAGram {
  
  /* A like is represented by a user */
  typedef InstagramUser InstagramLike;

}

#endif /* SEARCHAGRAM_INSTAGRAM_LIKE_H_ */
